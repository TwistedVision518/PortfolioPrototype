...
const textArray = ["Developer", "Python developer", "Server Administrator" , "Web Developer", "Web Designer", "Freelancer", "Programmer", "Operating System Developer"];
...
const targetWidths = [90, 90, 50, 80, 60]; // in percentage
